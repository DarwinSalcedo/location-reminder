...
class RemindersActivityTest : KoinTest {
    ...
    @Test
    fun addReminder_SaveReminder_showsSuccessToast() = runBlocking {
        val typingTitle = "TITTLE1"
        val typingDescription = "DESCRIPTION2"
    ...
    @Test
    fun addReminder_NotTitle_verifyShowErrorMessage() {
        val activityScenario = ActivityScenario.launch(RemindersActivity::class.java)
        dataBindingIdlingResource.monitorActivity(activityScenario)
        // Verify: no data is shown
        onView(withId(R.id.noDataTextView)).check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
        ...
        viewModel.selectedPOI.postValue(PointOfInterest(LatLng(-34.5808186,-58.4972602), "", "TEST POI"))
    ...
    @Test
    fun addReminder_NotDescription_verifyShowErrorMessage() {
        val activityScenario = ActivityScenario.launch(RemindersActivity::class.java)
        dataBindingIdlingResource.monitorActivity(activityScenario)
    ...
    @Test
    fun addReminder_NotLocation_verifyShowErrorMessage() {
        val activityScenario = ActivityScenario.launch(RemindersActivity::class.java)
        dataBindingIdlingResource.monitorActivity(activityScenario)
        ...
        onView(withId(R.id.reminderTitle)).perform(ViewActions.typeText("TITLE1"))
        onView(withId(R.id.reminderDescription)).perform(ViewActions.typeText("DESCRITION1"))
        closeSoftKeyboard()
